...
class NavisworksProvider(AECProvider):
    ...
    _capabilities = [
        ProviderTool(
            name="navisworks_health", 
            description="Check if Navisworks is running and get status information", 
            inputSchema={"type": "object", "properties": {}, "required": []}
        ),
        ProviderTool(
            name="navisworks_invoke_method", 
            description="Invoke a C# method in Navisworks via reflection", 
        ...
        ProviderTool(
            name="navisworks_reflect_get", 
            description="Get a C# property value from a Navisworks object via reflection", 
            inputSchema={"type": "object", "properties": {
                "target_id": {"type": "string"},
        ...
        ProviderTool(
            name="navisworks_reflect_set", 
            description="Set a C# property value on a Navisworks object via reflection", 
            inputSchema={"type": "object", "properties": {
                "target_id": {"type": "string"},
                "property_name": {"type": "string"},
                "value": {}
