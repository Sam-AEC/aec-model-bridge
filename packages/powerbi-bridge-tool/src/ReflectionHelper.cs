...
namespace PowerBIBridge
{
    public static class ReflectionHelper
    {
        ...
        public static object ParseArgument(JsonElement arg)
        {
            switch (arg.ValueKind)
            {
                ...
                case JsonValueKind.Object:
                    ...
                    {
                        return GetObject(arg.GetProperty("id").GetString());
                    }
                    return null;
                default:
                    return null;
        ...
        public static Type ResolveType(string typeName)
        {
            ...
            var assemblies = AppDomain.CurrentDomain.GetAssemblies()
                .Where(a => a.FullName.StartsWith("Microsoft.AnalysisServices") || a.FullName.StartsWith("System"));
            
            foreach (var asm in assemblies)
            {
                var type = asm.GetType(typeName) ?? asm.GetType("Microsoft.AnalysisServices.AdomdClient." + typeName);
        ...
        public static object InvokeMethod(string typeName, string methodName, JsonElement argsElement, string targetId = null)
        {
            ...
            if (argsElement.ValueKind == JsonValueKind.Array)
            {
                ...
                {
                    args.Add(ParseArgument(argJson));
                }
            }
